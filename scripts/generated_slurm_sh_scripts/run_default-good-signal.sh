#!/bin/bash
#SBATCH --job-name=dl-default-good-signal
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/default-good-signal/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/default-good-signal/job_error.log
...
python src/bsc_main.py -c default_good_signal
