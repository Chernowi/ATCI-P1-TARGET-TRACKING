...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/ppo-rnn/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/ppo-rnn/job_error.log
...
python src/bsc_main.py -c ppo_rnn
