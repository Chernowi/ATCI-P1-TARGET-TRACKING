#!/bin/bash
#SBATCH --job-name=dl-ppo-mlp-hidden-dim-small
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-hidden-dim-small/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-hidden-dim-small/job_error.log
...
python src/bsc_main.py -c ppo_mlp_hidden_dim_small
