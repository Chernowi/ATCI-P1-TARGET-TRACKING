...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/sac-rnn/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/sac-rnn/job_error.log
...
python src/bsc_main.py -c sac_rnn
