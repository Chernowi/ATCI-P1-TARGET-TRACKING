#!/bin/bash
#SBATCH --job-name=dl-ppo-mlp-policy-clip-high
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-policy-clip-high/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-policy-clip-high/job_error.log
...
python src/bsc_main.py -c ppo_mlp_policy_clip_high
