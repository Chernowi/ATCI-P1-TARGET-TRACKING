#!/bin/bash
#SBATCH --job-name=dl-ppo-mlp-entropy-coef-high
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-entropy-coef-high/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-entropy-coef-high/job_error.log
...
python src/bsc_main.py -c ppo_mlp_entropy_coef_high
