#!/bin/bash
#SBATCH --job-name=dl-ppo-mlp-n-epochs-high
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-n-epochs-high/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-n-epochs-high/job_error.log
...
python src/bsc_main.py -c ppo_mlp_n_epochs_high
