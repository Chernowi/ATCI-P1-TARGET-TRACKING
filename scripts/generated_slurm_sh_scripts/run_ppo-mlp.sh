...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp/job_error.log
...
python src/bsc_main.py -c ppo_mlp
