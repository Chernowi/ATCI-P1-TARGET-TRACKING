#!/bin/bash
#SBATCH --job-name=dl-ppo-mlp-actor-lr-low
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-actor-lr-low/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/ppo-mlp-actor-lr-low/job_error.log
...
python src/bsc_main.py -c ppo_mlp_actor_lr_low
