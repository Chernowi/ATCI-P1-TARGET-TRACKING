#!/bin/bash
#SBATCH --job-name=dl-sac-mlp-hidden-dims-small
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/sac-mlp-hidden-dims-small/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/sac-mlp-hidden-dims-small/job_error.log
...
python src/bsc_main.py -c sac_mlp_hidden_dims_small
