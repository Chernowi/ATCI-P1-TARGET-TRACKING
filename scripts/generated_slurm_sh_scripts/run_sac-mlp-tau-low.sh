#!/bin/bash
#SBATCH --job-name=dl-sac-mlp-tau-low
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/sac-mlp-tau-low/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/sac-mlp-tau-low/job_error.log
...
python src/bsc_main.py -c sac_mlp_tau_low
