#!/bin/bash
#SBATCH --job-name=dl-default-poor-signal
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/default-poor-signal/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/default-poor-signal/job_error.log
...
python src/bsc_main.py -c default_poor_signal
