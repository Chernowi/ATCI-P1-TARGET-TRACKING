#!/bin/bash
#SBATCH --job-name=dl-sac-mlp-critic-lr-high
...
#SBATCH --output=/home/nct/nct01026/ATCI-P1/out_logs/sac-mlp-critic-lr-high/job_output.log
#SBATCH --error=/home/nct/nct01026/ATCI-P1/out_logs/sac-mlp-critic-lr-high/job_error.log
...
python src/bsc_main.py -c sac_mlp_critic_lr_high
